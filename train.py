...
from models.transformer import Transformer, VisualEncoder, ScaledDotProductAttention
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='Sydney') # Sydney，UCM，RSICD, NWPU
